...
const StarlightProdactScreen = ({navigation, route}) => {
...
*/
  ...
  ////////////////////////////
  //let baseUrl = `https://super-grand-euphoria.space/JGRX6M98?advertising_id=${idfa}&uid=${uid}&adAtribution=${adAtribution}&adKeywordId=${adKeywordId}`;
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/icon/arrow77.png')}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/icon/redo77.png')}
          />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
...
export default StarlightProdactScreen;
